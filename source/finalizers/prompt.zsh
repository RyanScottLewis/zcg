...
THEME_PROMPT_KEYMAP_VI_INSERT="Insert"
THEME_PROMPT_KEYMAP_VI_COMMAND="Command"
THEME_PROMPT_KEYMAP_VI_OPERATOR_PENDING="Pending"
THEME_PROMPT_KEYMAP_VI_VISUAL="Visual"
